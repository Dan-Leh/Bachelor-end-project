...
EPOCHS = 100
POWER = 0.9
#RESTORE_FROM = '/home/jsun/Project/HeatNet-master/snapshots/train_epoch_50.pth'
RESTORE_FROM = ''
WEIGHT = ''
...
def main():
    ...
    #pre_trained_weight = torch.load('/home/jsun/Project/HeatNet-master/init_weights/pre_trained_psp_weights.pth')
    #model.load_state_dict({k: v for k, v in pre_trained_weight.items() if k in model.state_dict()}, strict=False)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for i_iter in range(max_iter):
            ...
            loss = train(epoch_log, model, model_D1, model_D2, images_source, labels, images_target, optimizer,\
                  optimizer_D1, optimizer_D2, source_label, target_label, i_iter+1, current_iter, max_iter, interp, interp_target)
...
def train(epoch_log, model, model_D1, model_D2, images_source, labels, images_target, optimizer, \
          optimizer_D1, optimizer_D2, source_label, target_label, i_iter, current_iter, max_iter, interp, interp_target):
