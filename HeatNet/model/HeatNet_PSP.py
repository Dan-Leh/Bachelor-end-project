...
class HeatNet_PSP(nn.Module):
    def __init__(self, layers=50, bins=(1,2,3,6), dropout=0.1, classes=20, zoom_factor=8, \
        ...
        # self.encoder_rgb_layer3 = resnet_raw_model1.layer3
        # self.encoder_rgb_layer4 = resnet_raw_model1.layer4 
        ...
        # self.encoder_thermal_layer2 = resnet_raw_model2.layer2
        # self.encoder_thermal_layer3 = resnet_raw_model2.layer3
        # self.encoder_thermal_layer4 = resnet_raw_model2.layer4
        
        # self.encoder_rgb_layer0 = nn.Sequential(resnet_raw_model2.conv1, resnet_raw_model2.bn1, \
        #                                         resnet_raw_model2.relu, resnet_raw_model2.conv2, \
        #                                         resnet_raw_model2.bn2, resnet_raw_model2.relu, \
        #                                         resnet_raw_model2.conv3, resnet_raw_model2.bn3, \
        #                                         resnet_raw_model2.relu, resnet_raw_model2.maxpool)
