...
def adjust_learning_rate_G(optimizer):
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch_log % 30 == 0: 
            adjust_learning_rate_G(optimizer)
        ...
        for i_iter in range(max_iter):
            ...
            adjust_learning_rate_D(optimizer_D1, current_iter, max_iter*args.epochs)
            adjust_learning_rate_D(optimizer_D2, current_iter, max_iter*args.epochs)
...
def train(epoch_log, model, model_D1, model_D2, images_source, labels, images_target, optimizer, \
    ...
    #                 'Accuracy {accuracy:.4f}.'.format(epoch_log, args.epochs, current_iter, len(train_loader),
