...
def get_parser():
    ...
    parser.add_argument('--image', type=str, default='E:/graduation project/semseg-master/figure/demo/_kjJB27gM3rYdj5NtbjasA.jpg', help='input image')
...
def test(model, image_path, classes, mean, std, base_size, crop_h, crop_w, scales, colors):
    ...
    gray_path = os.path.join('E:/graduation project/semseg-master/figure/demo/prediction/', image_name + '_gray.png')
    color_path = os.path.join('E:/graduation project/semseg-master/figure/prediction/', image_name + '_color.png')
...
#%%
import cv2
im = cv2.imread(r'E:\graduation project\mapillary_vistas_v2_part\training\images\__CRyFzoDOXn6unQ6a3DnQ.jpg',cv2.IMREAD_COLOR)
