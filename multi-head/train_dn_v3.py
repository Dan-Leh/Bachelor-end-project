...
"""
This verson is using the multi-head network with the modified decoder and the weights pre-trained on RGB-to-thermal task.
"""
...
# RESTORE_FROM = '/home/jsun/Project/multi-head/snapshots/dn_v3/train_epoch_10.pth'
ROOT = '/home/jsun/Project/Freiburg/'
LOG_SAVE_PATH = '/home/jsun/Project/multi-head/logs/dn_v3/50/'
SNAPSHOT_DIR = '/home/jsun/Project/multi-head/snapshots/dn_v3/50/'
BEST_DIR = '/home/jsun/Project/multi-head/best/dn_v3/50/'
WEIGHT_DECAY = 0.0005
...
def main():
    ...
    path = '/home/jsun/Project/multi-head/val/dn_v3/'
...
def train(model, optimizer_day, optimizer_night, model_D, optimizer_D, day, night, label_day, \
    ...
    if epoch_log <= args.first_epoch:
        ...
        return loss_seg_day_batch, loss_adv_batch, loss_D_batch
