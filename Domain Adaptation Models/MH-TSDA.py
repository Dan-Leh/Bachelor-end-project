# -*- coding: utf-8 -*-
"""
This is the code to train and evaluate MH-TSDA, the Multi-Head network with Teacher-Student Domain Adaptation.
...
ROOT = '/data/freiburg/'
LOG_SAVE_PATH = '/home/danleh/BEP-Dan/MH-TSDA/logs/'
SNAPSHOT_DIR = '/home/danleh/BEP-Dan/MH-TSDA/snapshots/'
BEST_DIR = '/home/danleh/BEP-Dan/MH-TSDA/best/'
WEIGHT_DECAY = 0.0005
...
def main():
    ...
    path = '/home/danleh/BEP-Dan/MH-TSDA/test/'
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for i_iter in range(max_iter):
            ...
            if epoch_log <= args.first_epoch:
                adjust_learning_rate(optimizer_day, current_iter, max_iter * args.first_epoch)
                adjust_learning_rate(optimizer_night, current_iter, max_iter * args.first_epoch)
            else:
                adjust_learning_rate(optimizer_day, current_iter-max_iter*args.first_epoch, max_iter * (args.epochs - args.first_epoch))
                adjust_learning_rate(optimizer_night, current_iter-max_iter*args.first_epoch, max_iter * (args.epochs - args.first_epoch))
            
            day, label_day = day_loader_iter.next()
            night, label_night = night_loader_iter.next()
            
            loss = train(model, optimizer_day, optimizer_night, day,night, label_day, label_night, epoch_log, current_iter, i_iter, max_iter)
        ...
        evaluate('day', test_loader_day, test_data_day.data_list, model, args.num_classes, gray_folder_day, \
                 color_folder_day, colors)
        evaluate('night', test_loader_night, test_data_night.data_list, model, args.num_classes, gray_folder_night, \
...
def train(model, optimizer_day, optimizer_night, day, night, label_day, \
